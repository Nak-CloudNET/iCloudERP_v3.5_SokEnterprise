...
<div id="wrap" style="width: 90%; margin: 0 auto;">
    <div class="row">
        <div class="col-lg-12">
			...
			<div>
                <div style="width:100%;">
					<span style="width:250px;display:inline-block;"><?=$this->lang->line("ក្រុមហ៊ុន/company");?></span>
					<span style="">
				...
				<div style="width:100%;">
					...
					<span style="">
						<?=($biller->phone ? ': '.$biller->phone .'/'.': '.$biller->email : ':'.$biller->email) ?>
					</span>
				</div>
				<div style="width:100%;">
					<span style="width:250px;display:inline-block;">
						<?=lang("អាស័យដ្ធាន/address") ?>
					</span>
					<span style="">
						<?=($biller->address ? ': '.$biller->address : '') ?>
					</span>
				</div>     
            </div>
			<div style="margin:10px;line-height:25px;">
				<p style="text-align:center;font-weight:bold;font-size:20px;">រិក័យបត្រ</p>
				<p style="text-align:center;font-weight:bold;font-size:20px;">Invoice</p>
			</div>
			
			<div style="width:50%;margin-bottom:10px;float:left;">
                <div style="width:100%;padding-right:10px;">
					<span style="width:40%;float:left;">
					<p style="word-wrap: break-word;"><?=$this->lang->line("អតិថិជន/customer");?></p>
					</span>
					<span style="width:60%;float:right;">
						<p style="word-wrap: break-word;"><?=$customer->company ? $customer->company : $customer->name;?></p>
					</span>
				</div>
				<div style="width:100%;clear:both;padding-right:10px;">
					<div style="width:40%;float:left;">
						<p style="word-wrap: break-word;"><?=lang("អាស័យដ្ធាន/address") ?></p>
					</div>
					<div style="width:60%;float:right;">
						<p style="word-wrap: break-word;"><?=$customer->address; ?></p>
					</div>
				</div>
				<div style="width:100%;clear:both;padding-right:10px;">
					<span style="width:40%;float:left;">
						<p style="word-wrap: break-word;"><?=lang("លេខទូស័ព្ទ/tel") ?></p>
					</span>
					<span style="width:60%;float:right;">
						<p style="word-wrap: break-word;"><?=($customer->phone ?$customer->phone .'/'.$customer->email : $customer->email) ?></p>
					</span>
				</div>	
				   
            </div>
			
			<div style="width:50%;margin-bottom:10px;float:right;">
                <div style="width:100%;">
					<span style="width:50%;float:left;">
					<p style="word-wrap: break-word;"><?=$this->lang->line("កាលបរិច្ឆេទ/date");?></p>
					</span>
					<span style="width:50%;float:right;">
						<p style="word-wrap: break-word;"><?= $inv->date ? $inv->date : ""; ?></p>
					</span>
				</div>
				<div style="width:100%;clear:both;">
					<div style="width:50%;float:left;">
						<p style="word-wrap: break-word;"><?= $this->lang->line("លេខយោង/reference_no") ?></p>
					</div>
					<div style="width:50%;float:right;">
						<p style="word-wrap: break-word;"><?= $inv->reference_no ? $inv->reference_no : ""; ?></p>
					</div>
				</div>
                ...
                <table class="table table-bordered table-hover table-striped" style="width: 100%;">
                    ...
                    foreach ($rows as $row):
                        ...
                        <tr>
                            ...
                            ?>
                            <td style="text-align:center; vertical-align:middle;width:80px;"><?= $this->erp->formatMoney($row->real_unit_price); ?></td>
                            <?php
                            if ($Settings->product_discount) {
                                echo '<td style="width: 50px; text-align:center; vertical-align:middle;">' . ($row->discount != 0 ? '<small>(' . $row->discount . ')</small> ' : '') . $this->erp->formatMoney($row->item_discount) . '</td>';
                            }
                            if ($Settings->tax1) {
                                //echo '<td style="width: 50px; text-align:center; vertical-align:middle;">' . ($row->item_tax != 0 && $row->tax_code ? '<small>(' . $row->tax_code . ')</small> ' : '') . $this->erp->formatMoney($row->item_tax) . '</td>';
                            }
                            ?>
                            <td style="text-align:center; vertical-align:middle; width:100px;"><?= $this->erp->formatMoney($row->subtotal); ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
                    ...
                    <tr>
                        ...
                        <td style="text-align:right; font-weight:bold;"><?= $this->erp->formatMoney($inv->grand_total - $inv->order_tax); ?></td>
                    </tr>
            ...
            <div class="row">
                ...
                <div class="clearfix"></div>
				<div class="col-xs-5" style="height: 80px;">
					<p class="" style="text-decoration-line: underline;">Payment Detail</p>
                    <p class="" style="">Bank Name &nbsp;&nbsp;&nbsp; : RHB Indochina</p>
                    <p class="" style="">Account Name : Romduol Beef</p>
                    <p class="" style="">Account No &nbsp;&nbsp;&nbsp;  : 101-0011-000001436</p>
                ...
                <div class="col-xs-4" style="">
                    ...
                    <hr>
                    <p class="text-center"><?= lang("Signature"); ?></p>
                </div>
            ...
            <div class="-table-responsive">
                <table class="table table-bordered table-hover table-striped" style="width: 100%;">
                    ...
                    foreach ($rows as $row):
                        ?>
                        <tr>
                            <td style="text-align:center; width:50px; vertical-align:middle;"><?= $r; ?></td>
                            <td style="vertical-align:middle;"><?= $row->product_name . " (" . $row->product_code . ")" . ($row->variant ? ' (' . $row->variant . ')' : ''); ?>
                                <?= $row->details ? '<br>' . $row->details : ''; ?>
                            </td>
                            ...
                            ?>
                            <td style="text-align:right; width:50px;"><?= $this->erp->formatMoney($row->real_unit_price); ?></td>
                            <?php
                            if ($Settings->tax1) {
                                echo '<td style="width: 50px; text-align:right; vertical-align:middle;">' . ($row->item_tax != 0 && $row->tax_code ? '<small>(' . $row->tax_code . ')</small> ' : '') . $this->erp->formatMoney($row->item_tax) . '</td>';
                            }
                            if ($Settings->product_discount) {
                                echo '<td style="width: 50px; text-align:right; vertical-align:middle;">' . ($row->discount != 0 ? '<small>(' . $row->discount . ')</small> ' : '') . $this->erp->formatMoney($row->item_discount) . '</td>';
                            }
                            ?>
                            <td style="vertical-align:middle; text-align:right; width:100px;"><?= $this->erp->formatMoney($row->subtotal); ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;

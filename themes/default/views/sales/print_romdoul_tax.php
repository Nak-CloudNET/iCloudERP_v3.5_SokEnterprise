    ...
    <div class="row">
        <div class="col-lg-12">
			...
			<div>
				...
				<div style="width:100%;">
					<span style="width:250px;display:inline-block;">
						<?=lang("លេខអត្តសញ្ញាណកម្មអតប/VATTIN")?>
					</span>
					<span style="">
						<?=': '.$biller->vat_no;?>
					</span>
			...
			<div style="margin:10px;line-height:25px;">
				<p style="text-align:center;font-weight:bold;font-size:20px;">រិក័យបត្រអាករ</p>
				<p style="text-align:center;font-weight:bold;font-size:20px;">Tax Invoice</p>
			</div>
			...
			<div style="width:50%;margin-bottom:10px;float:left;">
				...
				<div style="width:100%;clear:both;padding-right:10px;">
					<span style="width:40%;float:left;">
						<p style="word-wrap: break-word;"><?=lang("លេខអត្តសញ្ញាណកម្មអតប/VATTIN") ?></p>
					</span>
					<span style="width:60%;float:right;">
						<p style="word-wrap: break-word;"><?=($customer->vat_no ?$customer->vat_no : "") ?></p>
					</span>
				</div>  

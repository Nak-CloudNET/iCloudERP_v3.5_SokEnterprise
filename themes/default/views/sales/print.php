...
<div id="wrap" style="width: 90%; margin: 0 auto;">
    <div class="row">
        <div class="col-lg-12">
			...
			<a target="_blank" class="btn btn-primary" href="<?= site_url('sales/print_romdoul_tax/' . $sid); ?>"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("Print_Tax"); ?></a>
			<a target="_blank" class="btn btn-primary" href="<?= site_url('sales/print_romdoul/' . $sid); ?>"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;<?= lang("Print_No_Tax"); ?></a>
			<!--
